                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl outline-none focus:ring-4 focus:ring-primary/10 transition-all"
                    />
                  </div>
                    ...
                    {filteredInvoices.map(inv => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={`p-2 rounded-xl ${inv.type === 'sales' ? 'bg-primary/10 text-primary' : 'bg-rose-100 text-rose-600'} dark:bg-opacity-10`}>
